...
public class RadialTriangle {
    ...
    private float scale;
	public RadialTriangle(Point centerPoint,float scale) {
	...
	private void generateVectors() {
		...
		Point2D big = new Point2D(0,(int)(scale* -160));
		Point2D med = new Point2D(0, (int)(scale* -110));
		Point2D small = new Point2D(0, (int)(scale* -70));
		Point2D neg = new Point2D((int)(scale* -15), (int)(scale* -35));
		Point2D pos = new Point2D((int)(scale* 15), (int)(scale* -35));
		Point2D circle= new Point2D(0,(int)(scale* -200));
